    ...
    for thing in metadata['viewed_things']:
        if thing['name'] == 'Facebook Watch Videos and Shows':
            for child in thing['children']:
                if child['name'] == 'Shows':
                    for entry in child['entries']:
                        ...
                        create_engagement_event(source='facebook', identifier=request_identifier, engagement_type='video', start=created)
                    ...
                    for entry in child['entries']:
                        ...
                        create_engagement_event(source='facebook', identifier=request_identifier, engagement_type='video', start=created, duration=entry['data']['watch_position_seconds'])
            ...
            for entry in thing['entries']:
                ...
                create_engagement_event(source='facebook', identifier=request_identifier, engagement_type='link', start=created)
            ...
            for child in thing['children']:
                if child['name'] == 'Marketplace Items':
                    for entry in child['entries']:
                        ...
                        create_engagement_event(source='facebook', identifier=request_identifier, engagement_type='shopping', start=created)
            ...
            for entry in thing['entries']:
                ...
                create_engagement_event(source='facebook', identifier=request_identifier, engagement_type='advertising', start=created)
    ...
    for thing in metadata['visited_things']:
        if thing['name'] == 'Profile visits':
            for entry in thing['entries']:
                ...
                create_engagement_event(source='facebook', identifier=request_identifier, engagement_type='profile', start=created)
            ...
            for entry in thing['entries']:
                ...
                create_engagement_event(source='facebook', identifier=request_identifier, engagement_type='page', start=created)
            ...
            for entry in thing['entries']:
                ...
                create_engagement_event(source='facebook', identifier=request_identifier, engagement_type='event', start=created)
            ...
            for entry in thing['entries']:
                ...
                create_engagement_event(source='facebook', identifier=request_identifier, engagement_type='group', start=created)
